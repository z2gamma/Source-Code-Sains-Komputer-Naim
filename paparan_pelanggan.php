...
$sqlpaparan = "SELECT * FROM beli JOIN pelanggan ON beli.no_kp = pelanggan.no_kp JOIN tiket ON beli.id_tiket = tiket.id_tiket JOIN kategori ON pelanggan.kod_kategori = kategori.kod_kategori LIMIT $offset,$limitrekod";
$querypaparan = mysqli_query($sambungan, $sqlpaparan);
//Mengira jumlah rekod dari pangkalan data
$jumlah = mysqli_num_rows($querypaparan);
?>
<!doctype html>
<html>
<head>
    ...
    <title>Paparan pelanggan</title>
	<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.5.3/dist/css/bootstrap.min.css" integrity="sha384-TX8t27EcRE3e/ihU7zmQxVncDAy5uIKz4rEkgIXeMed4M0jlfIDPvg6uqKI2xXr2" crossorigin="anonymous">
    <link rel="stylesheet" href="css/paparan_pelanggan.css">
...
<body>
	<div id="wrapper">
		...
		<div id="body" class="bg-light">
			...
			<br>
			<div id="tablediv">
				<table class="table table-bordered border-dark" border="1" id="table">
					<tr id="pelanggan">
					...
					<?php while ($rows = mysqli_fetch_assoc($querypaparan)) {?>
					<tr id="pelanggan">
                ...
                <table class="table table-bordered" id="table">
                  ...
                  <td align="center"><a href="paparan_pelanggan.php?halaman=1">Awal<a></td>
                  <td align="center"><a href="paparan_pelanggan.php<?php if ($halaman == 1) {
    echo "?halaman=1";
} else {
    echo "?halaman=".($halaman - 1);
} ?>">Sebelum<a></td>
                  <td align="center"><a href="paparan_pelanggan.php<?php if ($halaman == $jumlah_halaman) {
    echo "?halaman=$jumlah_halaman";
} else {
    echo "?halaman=".($halaman + 1);
} ?>">Seterusnya<a></td>
                  <td align="center"><a href="paparan_pelanggan.php?halaman=<?php echo $jumlah_halaman ?>">Akhir<a></td>
                  </tr>
                </table>
			</div>
			<script type="text/javascript">
				$("#besarkan").click(function(){
				  $("table").css("font-size",(parseInt($("table").css("fontSize")) + 2) + "px");});
